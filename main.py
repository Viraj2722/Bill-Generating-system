...
class Bill_App:
    def __init__(self,root): 
       ...
       #SubCatClothing
        ...
        self.entry_mob =ttk.Entry(Cust_Frame,textvariable=self.C_phone,font=("arial",11,"bold"),width=18)
        ...
        self.txtCustName =ttk.Entry(Cust_Frame,textvariable=self.C_name,font=("arial",11,"bold"),width=18)
        ...
        self.txtEmail =ttk.Entry(Cust_Frame,textvariable=self.C_email,font=("arial",11,"bold"),width=18)
        ...
        self.Combo_Category = ttk.Combobox(Product_Frame,values=self.Category,font=("arial",11,"bold"),width=18,state='readonly')
        ...
        self.ComboSubCategory = ttk.Combobox(Product_Frame,values=[""],font=("arial",11,"bold"),width=18,state='readonly')
        ...
        self.ComboProduct = ttk.Combobox(Product_Frame,textvariable=self.Product,font=("arial",11,"bold"),width=18,state='readonly')
        ...
        self.ComboPrice = ttk.Combobox(Product_Frame,textvariable=self.Prices,font=("arial",11,"bold"),width=16,state='readonly')
        ...
        self.ComboQty = ttk.Entry(Product_Frame,textvariable=self.Qty,font=("arial",11,"bold"),width=18)
        ...
        MiddleFrame.place(x=10,y=150,width=900,height=300)
        ...
        lbl_img_12.place(x=0,y=0,width=440,height=300)
        ...
        lbl_img_22.place(x=440,y=0,width=440,height=300)
        ...
        RightLabelFrame.place(x=940,y=45,width=400,height=400)
        ...
        Bottom_Frame.place(x=0,y=445,width=1520,height=119)
        ...
        self.BtnAddToCart = Button(Btn_Frame,command=self.AddToCart,text="Add To Cart",font=("arial",15,"bold"),bg="orangered",fg="white",width=12,cursor="hand2")
        ...
        self.BtnPrint = Button(Btn_Frame,command=self.Bprint,text="Print",font=("arial",15,"bold"),bg="orangered",fg="white",width=12,cursor="hand2")
